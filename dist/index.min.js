...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Object$defineProperties = __webpack_require__(2)['default'];
	...
	var PaginationBox = (function (_React$Component) {
	    function PaginationBox(props) {
	        _classCallCheck(this, PaginationBox);
	
	        _get(Object.getPrototypeOf(PaginationBox.prototype), 'constructor', this).call(this, props);
	        this.state = {
	            list: []
	        };
	    }
	
	    _inherits(PaginationBox, _React$Component);
	    ...
	    _createClass(PaginationBox, [{
	        ...
	        value: function _setConfig() {
	            ...
	            _assign2['default'](def, this.props.options || this.props);
	         ...
	         * @private
	         */
	        value: function _addAngItem(type, disabled, page, increment) {
	            var text;
	            page = page || 0;
	            switch (type) {
	                case 'prev':
	         ...
	         * @private
	         */
	        value: function _firstLinks(list, interval) {
	            if (this.angularLink) {
	         ...
	         * @private
	         */
	        value: function _generatedPrevLink(list) {
	         ...
	         * @private
	         */
	        value: function _generatedNextLink(list) {
	         ...
	         * @private
	         */
	        value: function _intervalLink(list, interval) {
	         ...
	         * @private
	         */
	        value: function _lasterLinks(list, interval) {
	         ...
	         * @private
	         */
	        value: function _changePageHandler(page) {
	            setTimeout((function () {
	        ...
	        value: function render() {
	            return _React2['default'].createElement(
	                ...
	                _React2['default'].createElement(_List2['default'], { reload: this.reload, list: this.state.list, changePage: this._changePageHandler.bind(this) })
	            );
	        }
	    }]);
	...
	PaginationBox.propsTypes = {
	    ...
	    handlers: _React2['default'].PropTypes.array,
	    selectHandler: _React2['default'].PropTypes.func,
	    startPageHandler: _React2['default'].PropTypes.func
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _classie = __webpack_require__(196);
	...
	var List = (function (_React$Component) {
	    ...
	    _createClass(List, [{
	         ...
	         * @private
	         */
	        value: function _changePageHandler(e) {
	            var target = e.target,
	            ...
	            if (!this.props.reload) {
	                ...
	                if (type === 'true') {
	                    if (!_classie2['default'].has(parent, 'disabled')) {
	                        this.props.changePage(parseInt(target.getAttribute('data-page')));
	                    }
	                } else {
	                    if (!_classie2['default'].has(parent, 'active')) {
	                        this.props.changePage(parseInt(target.getAttribute('data-page')));
	                    }
	                }
	            } else {
	        ...
	        value: function render() {
	            var pages = this.props.list.map((function (item, i) {
	                if (item.link) {
	                    return _React2['default'].createElement(
	                        'li',
	                        { key: i, className: item['class'] },
	                        _React2['default'].createElement(
	                            'a',
	                            { href: item.href, 'data-angular': item.angular, 'data-page': item.page, onClick: this._changePageHandler.bind(this) },
	                            item.text
	                        )
	                    );
	                } else {
	...
	List.propsTypes = {
	    reload: _React2['default'].PropTypes.boolean,
	    list: _React2['default'].PropTypes.array,
	    changePage: _React2['default'].PropTypes.func
	};
	module.exports = exports['default'];

	/* REACT HOT LOADER */ }).call(this); if (false) { (function () { module.hot.dispose(function (data) { data.makeHot = module.makeHot; }); if (module.exports && module.makeHot) { var makeExportsHot = require("J:\\fromGIT\\react-pagination\\node_modules\\react-hot-loader\\makeExportsHot.js"), foundReactClasses = false; if (makeExportsHot(module, require("react"))) { foundReactClasses = true; } var shouldAcceptModule = true && foundReactClasses; if (shouldAcceptModule) { module.hot.accept(function (err) { if (err) { console.error("Cannot not apply hot update to " + "List.react.jsx" + ": " + err.message); } }); } } })(); }
...
/***/ function(module, exports, __webpack_require__) {
	...
	if ("production" !== process.env.NODE_ENV) {
	  React.addons.Perf = __webpack_require__(169);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var classList = __webpack_require__(199),
	    classie;
